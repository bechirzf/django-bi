from reporting.lib import transform_python_list_to_list_for_echarts
from reporting.models.report import BaseReport
from reporting.tests.fixtures.objects.datasets.dummy import DummyDataset
