...
class DashboardTests(TestCase):
    ...
    def test_get_parent_dashboard_class(self):
        ...
        self.assertEqual(
            str(dummy_board3.get_parent_dashboard_class()), str(dummy_board1))

    def test_get_parent_dashboard(self):
        dummy_board3_class = get_class_by_path('dashboards/dummy1/dummy3.py',
                                               'Dashboard')
        self.assertEqual(
            str(type(dummy_board3_class.get_parent_dashboard())),
...
class ReportTests(TestCase):
    ...
    def test_get_url_raw(self):
        ...
        self.assertEqual(dr1.get_url_raw(),
                         '/reports/dummy1/raw/?param1=123&param2=abc')
    ...
    def test_get_url(self):
        ...
        dr1 = DummyReport1({'param1': 123, 'param2': 'abc'})
        self.assertEqual(dr1.get_url(),
                         '/reports/dummy1/?param1=123&param2=abc')
...
class DatasetTests(TestCase):
    ...
    def test_get_cached_methods(self):
        self.assertEqual(DummyDataset.get_cached_dataset_methods(),
                         ['get_dataframe'])
