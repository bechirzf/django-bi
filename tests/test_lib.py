...
class LibTests(TestCase):
    ...
    def test_cache_dataframe_decorator(self):
        cache.clear()
        dds = DummyDataset()
        self.assertIsNone(cache.get('1ac2c3f598d5ffe967c16170e50e3405'))
        dds.get_dataframe()
        self.assertIsNotNone(cache.get('1ac2c3f598d5ffe967c16170e50e3405'))
        cache_time = cache._expire_info.get(cache.make_key('1ac2c3f598d5ffe967c16170e50e3405'))
        dds.get_dataframe()
        self.assertEqual(cache._expire_info.get(cache.make_key('1ac2c3f598d5ffe967c16170e50e3405')), cache_time)
